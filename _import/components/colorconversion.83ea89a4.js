//
// Bjorn Ottosson color conversion functions.
// From https://github.com/bottosson/bottosson.github.io/blob/master/misc/colorpicker/colorconversion.js
// 

export {rgb_to_hsl, hsl_to_rgb, rgb_to_hsv, hsv_to_rgb, srgb_transfer_function, srgb_transfer_function_inv, 
        linear_srgb_to_oklab, oklab_to_linear_srgb, toe, toe_inv, okhsv_to_srgb, srgb_to_okhsv,
        find_gamut_intersection, find_cusp, srgb_to_okhsl, okhsl_to_srgb, rgb_to_oklch, oklch_to_rgb };
...
function oklch_to_rgb(L, C, h) {
    ...
    return rgb.map(d=>255 * clamp(srgb_transfer_function(d)))
}
